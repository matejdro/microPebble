...
Java_io_rebble_cobble_speexcodec_SpeexCodec_decode(JNIEnv *env, jobject thiz,
...
Java_io_rebble_cobble_speexcodec_SpeexCodec_initSpeexBits(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_io_rebble_cobble_speexcodec_SpeexCodec_initDecState(JNIEnv *env, jobject thiz, jlong sample_rate,
                                                      jint bit_rate) {
...
Java_io_rebble_cobble_speexcodec_SpeexCodec_destroySpeexBits(JNIEnv *env, jobject thiz,
                                                          jlong speex_bits) {
...
extern "C"
JNIEXPORT void JNICALL
Java_io_rebble_cobble_speexcodec_SpeexCodec_destroyDecState(JNIEnv *env, jobject thiz,
                                                         jlong dec_state) {
...
extern "C"
JNIEXPORT void JNICALL
Java_io_rebble_cobble_speexcodec_SpeexCodec_initNative(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_io_rebble_cobble_speexcodec_SpeexCodec_destroyPreprocessState(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_io_rebble_cobble_speexcodec_SpeexCodec_initPreprocessState(JNIEnv *env, jobject thiz,
