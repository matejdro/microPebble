      ...
      Column(Modifier.safeDrawingPadding()) {
         PullToRefreshBox(
            ...
            LazyVerticalGrid(
               ...
               stickyHeader(contentType = categoryHeaderContentType) {
                  Row(
                     modifier = Modifier
                        .fillMaxWidth()
                     ...
                     Row(
                        ...
                        Text((viewModel.page + 1).toString())
                        val canGoToNext =
                           state is Outcome.Success
                              && (!viewModel.hasFoundEnd || viewModel.page + 1 in viewModel.collections.indices)
                        IconButton(
